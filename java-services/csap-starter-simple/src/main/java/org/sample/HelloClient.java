...
public class HelloClient {
	...
	public String helloRandom ( ) {
		...
		String serviceUrl = csapServiceLocator.getRandomInstance( csapServiceLocator.getServiceUrls(
				getHelloProvider( ) ) ) ;
	...
	public String helloRoundRobin ( ) {
		...
		String serviceUrl = csapServiceLocator.getRoundRobinInstance( csapServiceLocator.getServiceUrls(
				getHelloProvider( ) ) ) ;
		logger.info( "Using binding: {} ", serviceUrl ) ;
