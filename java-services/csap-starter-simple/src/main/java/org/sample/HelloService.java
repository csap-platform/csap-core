...
public class HelloService {
	...
	public static final String HELLO_WITH_REST_ACL = "/helloWithRestAcl" ;
	...
	@RequestMapping ( {
			"helloWithOptionalName", "helloWithOptionalName/{name}"
	} )
	...
	// Landing Page
	@Async ( Csap_Simple_Application.ASYNC_EXECUTOR )
	...
	@RequestMapping ( HELLO_WITH_REST_ACL )
