...
public class KubernetesApiTests extends CsapThinNoProfile {
	...
	class Statefull {
		...
		public V1PodSpec buildPodSpec ( String containerName ) {
			...
			// nodeSelector.put( "kubernetes.io/hostname", "csap-dev04.lab.sensus.net" ) ;
...
//					.contains( "Delete Succeeded - known issue" ) ;
	...
	class Stateless {
		...
		public void list_nodes ( )
			...
			V1Node dev4 = apiV1.readNodeStatus( "csap-dev04.lab.sensus.net", null ) ;
			// s.getStatus().
			// dev4.getStatus().al
...
//									"/api/v1/namespaces/kube-system/pods?limit=1",
		...
		public void field_selectors ( )
			...
			var podFieldSelector = "spec.nodeName=csap-dev04.lab.sensus.net" ;
			...
			// var eventFieldSelector = "source.host=csap-dev04.lab.sensus.net" ;
