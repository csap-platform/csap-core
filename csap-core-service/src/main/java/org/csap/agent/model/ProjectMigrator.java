...
public class ProjectMigrator {
	...
	public void migrateIfRequired ( File projectFile , ObjectNode modelDefinition ) {
		...
		try {
			...
			if (false &&  projectFile.getAbsolutePath( ).contains( "target" ) ) {
				...
				logger.warn( CsapApplication.testHeader( "Exporting migrated definition: {}" ), projectFile.getAbsolutePath( ) ) ;
	...
	private void migrate_2_0_csap_service_definitions ( StringBuilder info , String fileName ,
	...
	private void migrate_2_0_environments ( StringBuilder info , String fileName , ObjectNode modelDefinition ) {
		...
		if ( ( legacyCapability != null ) && legacyCapability.isObject( ) ) {
			...
			helpMenu.put( "User Guide", "https://xyleminc.atlassian.net/wiki/spaces/CSAP" ) ;
			helpMenu.put( "Release Notes",
					"https://xyleminc.atlassian.net/wiki/spaces/CSAP/pages/258211856/Release+Notes" ) ;
			helpMenu.put( "Quick Install",
					"https://xyleminc.atlassian.net/wiki/spaces/CSAP/pages/395282580/CSAP+Quick+Install" ) ;
			helpMenu.put( "Health Status",
					"https://xyleminc.atlassian.net/wiki/spaces/CSAP/pages/258211861/CSAP+Health" ) ;
			helpMenu.put( "Application Editor",
					"https://xyleminc.atlassian.net/wiki/spaces/CSAP/pages/258211875/CSAP+Application+Editor" ) ;
			helpMenu.put( "FAQ", "https://xyleminc.atlassian.net/wiki/spaces/CSAP/pages/347177032/CSAP+FAQ" ) ;
	...
	private void migrate_2_0_collectionSettings ( String fileName , StringBuilder info , ObjectNode settings ,
