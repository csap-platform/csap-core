...
public class ProjectOperators {
		...
		try {
			...
			if ( definitionOperations.isArray( ) ) {
				...
				try {
					...
					logger.warn( "Failed to load: {}: {}", CSAP.jsonPrint( definitionOperations ), CSAP.buildCsapStack( e ) ) ;
				}
	...
	private void processModificationsWithDotSupport ( JsonNode containerDefinition ,
	...
	private void updateSettings ( ObjectNode activeEnv ,
			ObjectNode definitionEnvironments ,
	...
	private ObjectNode updateClusters ( ObjectNode autoplayClusters ,
	...
	public ObjectNode pushDown ( String sourceClusterName ,
