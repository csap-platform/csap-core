...
public class HealthForAgent {
	...
	public void service_summary ( ObjectNode summaryJson , boolean blocking ,
			String clusterFilter , ObjectNode activeServiceReport ,
		...
		csapApp
				...
				.forEach( serviceInstance -> {
					...
					logger.debug( "{} : Active {}", serviceInstance.getName( ), serviceInstance.getDefaultContainer( ).isActive( ) ) ;
