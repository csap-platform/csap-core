...
public class ModelApi {
	...
	public JsonNode serviceNames ( @RequestParam ( defaultValue = Application.ALL_PACKAGES ) String project ,
	...
	public JsonNode serviceNamesAll ( @RequestParam ( defaultValue = Application.ALL_PACKAGES ) String project ,
			@RequestParam ( required = false ) List<String> cluster ,
			@RequestParam ( defaultValue = "false" ) boolean appendInfo ,
			@RequestParam ( defaultValue = "false" ) boolean reverse ) {
	...
	public JsonNode serviceIds ( @RequestParam ( defaultValue = Application.ALL_PACKAGES ) String project ,
			@RequestParam ( required = false ) List<String> cluster ,
			@RequestParam ( defaultValue = "false" ) boolean appendInfo ,
			@RequestParam ( defaultValue = "false" ) boolean reverse ) {
	...
	private JsonNode getIdOrNames ( boolean includeOnlyAutostart , boolean isId , String projectName ,
			List<String> clusterFilter ,
			boolean appendInfo , boolean reverse ) {
		if ( projectName == null ) {
