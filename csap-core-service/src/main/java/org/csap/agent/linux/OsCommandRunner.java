...
public class OsCommandRunner {
	...
	public String runUsingDefaultUser ( String short_desc , List<String> script , BufferedWriter outputWriter ,
	...
	public String executeString ( List<String> params , Map<String, String> environmentVariables ,
			File workingDir ,
			HttpServletResponse response , HttpSession session ,
			int hungProcessIntervalInSeconds , int hungProcessMaxIterations ,
			BufferedWriter outputWriter ) {
	...
	private String executeUsingDesktopStubs ( List<String> params , Map<String, String> environmentVariables ,
			BufferedWriter outputWriter ) {
