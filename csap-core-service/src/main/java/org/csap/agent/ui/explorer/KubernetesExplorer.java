...
public class KubernetesExplorer {
	...
	public JsonNode cli_get_by_link ( @PathVariable String documentType ,
	...
	public ObjectNode pod_describe (
			@PathVariable String namespace , @PathVariable String pod )
			throws IOException {
	...
	public ObjectNode deploy_describe (
			@PathVariable String namespace , @PathVariable String deploy )
			throws IOException {
