...
public class DefinitionRequests {
	...
	private ObjectNode decodeLine ( boolean isYaml ,
			String line ,
	...
	private ObjectNode encodeLine ( boolean isYaml ,
			String line ,
			StandardPBEStringEncryptor csapEncrypter ,
			StringBuilder updatedContent ) {
	...
	public AtomicInteger removeDefinitionReferences ( String containerId , ObjectNode testPackageModel ,
	...
	private AtomicInteger updateDefinitionWithRenameReferences ( String containerId , ObjectNode testPackageModel ,
			String oldServiceName ,
			String newName ) {
	...
	private boolean validate_model_name_format_and_unused ( Project currentPackageModel , String newName ,
	...
	private void check_out_definition ( String scmUserid , boolean isUpdateAll , String scmBranch ,
			String encryptedPass , ServiceInstance dummyServiceInstanceForApp , OutputFileMgr outputManager ,
	...
	private void activate_definition (
			OutputFileMgr outputManager , StringBuilder parsingResultsBuffer ,
			boolean isApplyOnly , File workingPackageDefinitionFile ,
			String scmBranch , File workingApplicationFolder ,
			String scmUserid , String encryptedPass ,
			String comment , String csapProjectName ,
	...
	private void updateWorkingGitSource ( OutputFileMgr outputManager , String scmBranch ,
