...
public class ServiceCollector extends HostCollector implements Runnable {
	...
	private void updateTimeStampAndCpu ( ) {
		...
		//ObjectNode hostRuntimeNode = (ObjectNode) osManager.buildServiceStatsReportAndUpdateTopCpu( true ) ;
...
//		}
	...
	public static String TEST_HOST = "csap-dev01.lab.sensus.net" ;
	...
	private ObjectNode build_java_collection ( boolean isUpdateSummary , int requestedSampleSize ,
	...
	private ObjectNode build_application_collection ( boolean isUpdateSummary ,
			int requestedSampleSize ,
			List<String> servicesFilter ,
			int numSamples ) {
	...
	private ObjectNode build_java_attributes ( List<String> servicesFilter ,
	...
	private ObjectNode build_application_attributes ( List<String> requestedServiceIds ,
			int requestedSampleSize , int skipFirstItems ) {
