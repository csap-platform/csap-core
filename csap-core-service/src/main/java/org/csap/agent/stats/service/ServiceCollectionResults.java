...
public class ServiceCollectionResults {
	...
	public void add_results_to_application_collection ( Map<String, ObjectNode> latest_application_collection ,
			String serviceId ) {
	 ...
	 */
	private void ensure_application_cache_initialized ( String serviceId ,
