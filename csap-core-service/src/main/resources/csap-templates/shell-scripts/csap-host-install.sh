...
function configure() {
	...
	installerFile="disabled" ;										# $CSAP_FOLDER/auto-plays/morrisville/kubernetes-cluster-auto-play.yaml
	
	# Sample settings
	#definitionProvider="default" ; hostsToInstall="csap-dev20" ; hostsRootPassword=xxxx ; installerFile="$csapDefinitionFolder/scripts/sensus-auto-play.yaml"
	...
	#   eg csapEpelRepo="http://media.lab.sensus.net/media/third_party/linux/CentOS/Sensus-epel-7.repo""
	...
	csapZipUrl="http://devops-prod01.lab.sensus.net:8081/artifactory/csap-release/org/csap/csap-host/21.06/csap-host-21.06.zip"
