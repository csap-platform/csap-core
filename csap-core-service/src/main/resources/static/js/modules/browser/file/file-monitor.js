...
import logFormatters from "./log-formatters.js"



const fileMonitor = File_Monitor();
...
function File_Monitor() {
    ...
    function latest_changes_request() {
        ...
        if ( ! selectedItem ) {
            console.warn( `fileSelection is undefined` ) ;
            return 
        }
        ...
        $.getJSON(
            ...
            .fail( function ( jqXHR, textStatus, errorThrown ) {
                ...
                _csapCommon.handleConnectionError( "Retrieving changes for file " + $fileSelection.val(), errorThrown );
            } );
    ...
    function processLogReport( dockerOrPodLogReport ) {
        ...
        if ( dockerOrPodLogReport.error ) {
            ...
            checkForChangesTimer = setTimeout( latest_changes_request, 2000 ) ;
            return;
        }
    ...
    function schedule_next_tail( changeReport ) {
        ...
        checkForChangesTimer = setTimeout( latest_changes_request, refreshTimer );
    }
