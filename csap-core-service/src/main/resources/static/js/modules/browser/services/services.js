...
import kubeDescribe from "./kubernetes-describe.js"

import kevents from "./kevents.js"

import keventDetails from "./kevent-details.js"
...
export const deployments = deployments_views();

export default deployments;


function deployments_views() {
    ...
    function serviceSummaryGet( $displayContainer, blockingUpdate, autoRefresh ) {
        ...
        let viewLoadedPromise = _net.httpGet( servicesUrl, parameters );
