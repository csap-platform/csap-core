...
function performance_views() {
    ...
    function showUserActivityTrends() {
        ...
        return summaryTrends.showUserActivity( $container, numberOfDays, $activityByHost.is( ":checked" ), 1 );
    }
    ...
    function showKubernetesRealTime( $menuContainer, forceHostRefresh, menuPath ) {
        ...
        let viewLoadedPromise = _net.httpGet( `${ APP_BROWSER_URL }/kubernetes/realtime`, parameters );

        viewLoadedPromise
            .then( kubernetesReport => {
                _dom.logArrow( `kubernetesReport`, kubernetesReport );
