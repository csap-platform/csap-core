...
import { _net, _dom, _dialogs } from "../../utils/all-utils.js";


import { aceEditor, jsYaml } from "../../libs/file-editor.js"

import csapEncoder from "../../misc/property-encoder.js"


_dom.onReady( function () {

    let appScope = new host_file_editor( globalThis.settings );
