...
//                $formatSelection.val( "columns" ) ;
    ...
    function formatLine( logLine, currentFormat ) {
        ...
        if ( currentFormat === "kubelet" ) {
            //
            // format 1: typical
            // Mar 22 09:41:42 csap-dev07.lab.sensus.net kubelet[650075]: E0322 09:41:42.876820  650075 reflector.go:138] object-"kube-system"/"kubernetes-services-endpoint":
            // format 2: wrapped
            // Mar 31 09:00:36 csap-dev05.lab.sensus.net kubelet[8146]: 2021-03-31 09:00:36.536 [INFO][19709] k8s.go 569: Teardown processing complete. ContainerID="xxx"
            // fromat 3:
            // Mar 31 09:00:36 csap-dev05.lab.sensus.net kubelet[8146]: time="2021-03-31T09:00:36-04:00" level=info msg="Released host-wide IPAM lock." source="ipam_plugin.go:369"
            //
            // Mar 31 15:35:55 csap-dev07.lab.sensus.net systemd[1]: Stopping kubelet: The Kubernetes Node Agent...
