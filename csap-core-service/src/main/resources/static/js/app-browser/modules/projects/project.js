define( [ "projects/file-browser", "browser/utils" ], function ( fileBrowser, utils ) {
    ...
    return {
        ...
        show: function ( $menuContent, forceHostRefresh, menuPath ) {
            ...
            if ( operation ) {
                ...
                if ( !editor ) {
                    require( [ "projects/editor" ], function ( Xeditor ) {
                        editor = Xeditor ;
                        editor.initialize() ;
                        editor.updatePackageMap( latestPackageMap ) ;
                        editor.show( $menuContent, forceHostRefresh, menuPath ) ;
                    } ) ;
                } else {
                    $menuLoaded = editor.show( $menuContent, forceHostRefresh, menuPath ) ;
                }
            }
