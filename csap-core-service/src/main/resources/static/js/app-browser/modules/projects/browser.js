    ...
    function buildJsonTreeEditor() {
        ...
        _projectJsonEditor.getSession().on( 'change', function () {
            let waitForLoadComplete = function () {
                ...
                if ( isJson ) {
                    ...
                    try {
                        // safeLoadAll - would convert json to array of docs - so safeLoad only
                        const updatedYaml = jsYaml.safeLoad( updatedContent ) ;
        ...
        $jsonModeCheckbox.change( function () {
            ...
            if ( isJson ) {
                ...
                try {
                    const updatedYaml = jsYaml.safeLoad( latestContent ) ;
